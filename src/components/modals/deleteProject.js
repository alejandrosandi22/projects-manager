  ...
  const [deleteProject] = useMutation(DELETE_PROJECT, {
    ...
    onCompleted: () => {
      dispatch({
        type: '@alert/show',
        payload: {
          status: true, type: 'success', message: `${data.name} deleted successfully`, seconds: 5,
        },
      });
      closeModal();
    },
    ...
    <section className={`${styles.section} ${hidde && styles.hidde}`}>
      <span>
        ...
        <p>
          ...
          {' '}
          permanently. You will not be able to recover your project.
        </p>
        <div>
